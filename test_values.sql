INSERT INTO users(id, name, email, password, phone, city, postal_code, street, building_no)
...
INSERT INTO shipments(id, sender_id, recipient_phone, size, name, city, postal_code, street, building_no)
